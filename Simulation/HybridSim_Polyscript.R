...
#set 2
names_vector <- paste0("Poly",31:60)
...
#set 3
names_vector <- paste0("Poly", 61:90)
...
#set 4
names_vector <- paste0("Poly", 91:96)
...
traits <- traits[order(as.numeric(sub("Poly", "", traits)))]

VarianceE <- VarianceE[traits]

#VarianceE <- diag(varG(pop2))*(1-0.3) / 0.3
